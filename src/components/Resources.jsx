...
function ResourcePattern({ mouseX, mouseY, ...gridProps }) {
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#b48e36] to-[#ffba75] opacity-0 transition duration-300 group-hover:opacity-100 dark:from-[#b48e36]/10 dark:to-[#ffba75]/10"
        style={style}
      />
      <motion.div
